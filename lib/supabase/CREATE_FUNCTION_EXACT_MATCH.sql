...
SELECT 
  ...
  CASE 
    ...
    THEN '✅ Ordre correspond à l''erreur'
...
BEGIN
  RAISE NOTICE '========================================';
  RAISE NOTICE '✅ Fonction créée avec l''ordre EXACT de l''erreur';
  RAISE NOTICE '========================================';
